      ...
      > 
        <ResizeBox 
          {...registerDragEvent((delX:number,delY:number)=>{
            ...
            // 좌상단
            //  setConfig({
            //   x: inRange(x+delX, BOUNDARY_MARGIN, x+w+MIN_W),
            //   y: inRange(y+delY, BOUNDARY_MARGIN, y+h+MIN_H) ,
            //   w: inRange(w - delX, MIN_W, w + x - BOUNDARY_MARGIN),
            //   h: inRange(h - delY, MIN_H, h + y - BOUNDARY_MARGIN),
            // })
